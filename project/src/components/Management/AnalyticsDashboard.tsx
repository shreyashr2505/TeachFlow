...
const AnalyticsDashboard: React.FC = () => {
  ...
  const analyticsLocked = currentClass ? !canAccessFeature('advanced_analytics', currentClass.plan, planSettings) : false;
  ...
  if (analyticsLocked && currentClass) {
    return (
      <UpgradeCard
        title="Analytics Locked"
        description="Advanced analytics is disabled on the current plan. Your saved data is preserved and will become visible again after you upgrade."
        requiredPlan="Pro"
