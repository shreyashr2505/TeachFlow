...
import { LogOut, User, Settings, X, Save, Moon, Sun } from 'lucide-react';
    ...
    <>
      ...
      {showSettings && (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black bg-opacity-50 px-4 py-6">
          <div className="my-auto flex w-full max-w-2xl max-h-[calc(100vh-3rem)] flex-col overflow-hidden rounded-xl bg-white p-6">
